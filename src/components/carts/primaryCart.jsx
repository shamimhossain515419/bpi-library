...
const PrimaryCart = ({ product }) => {
    ...
    return (
        <div className=' md:w-[220px] w-full'>
            ...
            <div className=' pt-2'>
                <Link href={'/'} className='text-[14px]   lg:text-[17px] hover:text-primary d duration-200 font-bold '>The Story of Success</Link>
                ...
                <p className=' text-[12px] lg:text-[18px] text-primary font-medium '>Quntity: 34</p>
            </div>
        </div>
    );
};
