                         ...
                         <div>
                              ...
                              >
                                   ...
                                   <SwiperSlide className=" ">
                                        <div className=' w-full relative group   h-[500px] md:h-[800px] overflow-hidden'>
                    ...
                    <div className='w-full flex  lg:flex-row flex-col  justify-center '>
                         <div className='  w-full lg:w-[70%] bg-tertiary py-10 '>
                              <div className='   w-full flex justify-center items-center h-full px-4'>
                                   <div className=' w-full relative'>
                                        <input className='w-full border-b pb-1 text-[18px] md:text-[25px] focus:border-primary  text-black border-gray-600 outline-0  placeholder:text-black  bg-transparent' type="search" placeholder='Search' />
                         ...
                         <div className='  w-full lg:w-[30%]  bg-gradient-to-r from-primary py-8 to-primary'>
                              <div className='text-white text-center'>
                                   <p className='text-[12px] md:text-[15px] font-normal'>The library is open today</p>
                                   <h1 className=' text-[20px] md:text-[25px] lg:text-[35px] font-medium py-1'>6:00 AM – 8:00 PM</h1>
                              </div>
                         </div>
                    </div>
               </div>
